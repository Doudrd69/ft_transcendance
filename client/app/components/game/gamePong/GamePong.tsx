...
const PongComponent = () => {
	...
	useEffect(() => {
		...
		if (pongContainer) {
			const handleResize = () => {
				const minSize = Math.min(pongContainer.clientWidth - 5, pongContainer.clientHeight -5);
			...
			<div className="pong-container" style={{ width: containerSize, height: containerSize }} tabIndex={0}>
				<div className="scoreboard">
					<div className='col-heading'>
						...
						<div className='score-heading' id={Game.playerOneLogin}>
							{gameState.scoreOne}
						</div>
					</div>
					<div className='col-heading'>
						...
						<div className='score-heading' id={Game.playerTwoLogin}>
							{gameState.scoreTwo}
						</div>
					</div>
				</div>
				<div className="ball" style={{ left: `${gameState!.BallPosition!.x - 0.5 * 0.04 * containerSize}px`, top: `${gameState!.BallPosition!.y - 0.5 * 0.04 * containerSize}px`, width: 0.04 * containerSize, height: 0.04 * containerSize }}/>
				<div className="pongpaddle" style={{ top: `${gameState!.paddleOne!.y}px`, left: `${gameState!.paddleOne!.x}px`, width: `${gameState!.paddleOne!.width}px`, height: `${gameState!.paddleOne!.height}px` }}/>
				<div className="pongpaddle" style={{ left: `${gameState!.paddleTwo!.x}px`, top: `${gameState!.paddleTwo!.y}px`, width: `${gameState!.paddleTwo!.width}px`, height: `${gameState!.paddleTwo!.height}px` }}/>
				{countdown > 0 && (
